      ...
      <div className="mx-auto max-w-4xl px-6 lg:px-12">
        ...
        <div className="mb-10 opacity-0 animate-fade-up" style={{ animationFillMode: 'forwards' }}>
          <div className="flex items-start gap-4">
            ...
            <div>
              <h1 className="text-4xl font-black uppercase tracking-tight text-black mb-2">{t('backgroundRemover.title')}</h1>
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center opacity-0 animate-fade-up" style={{ animationDelay: '0.25s', animationFillMode: 'forwards' }}>
            {pendingCount > 0 && (
              <button
                ...
                className="group relative inline-flex items-center justify-center gap-2 px-6 py-3 rounded-xl bg-[oklch(0.70_0.20_290)] text-[oklch(0.08_0.01_240)] font-semibold transition-all hover: disabled:opacity-50 disabled:cursor-not-allowed"
              >
                {isProcessing ? (
                  <>
