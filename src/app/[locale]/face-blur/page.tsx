      ...
      <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-10 opacity-0 animate-fade-up" style={{ animationFillMode: 'forwards' }}>
          <div className="flex items-start gap-4">
            <div className="flex-shrink-0 w-14 h-14 rounded-2xl bg-[oklch(0.70_0.22_25)] flex items-center justify-center shadow-[0_0_30px_oklch(0.70_0.22_25/0.3)]">
              <FaceBlurIcon size={28} className="text-[oklch(0.08_0.01_240)]" />
            </div>
            <div>
              <h1 className="text-3xl font-bold tracking-tight text-[oklch(0.95_0.01_80)]">{t('faceBlur.title')}</h1>
              <p className="mt-1 text-[oklch(0.55_0.02_240)]">{t('faceBlur.description')}</p>
            </div>
          </div>
        </div>
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center opacity-0 animate-fade-up" style={{ animationDelay: '0.25s', animationFillMode: 'forwards' }}>
            {pendingCount > 0 && (
              <button onClick={handleDetect} disabled={isProcessing}
                className="group relative inline-flex items-center justify-center gap-2 px-6 py-3 rounded-xl bg-[oklch(0.70_0.22_25)] text-[oklch(0.08_0.01_240)] font-semibold transition-all hover:shadow-[0_0_30px_oklch(0.70_0.22_25/0.4)] disabled:opacity-50 disabled:cursor-not-allowed">
